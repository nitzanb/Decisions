<template>
    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
          ...
          <div class="mb-4 px-4">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4  hover:bg-gray-200 rounded-lg cursor-pointer" :class="route().current('dashboard') ? 'bg-gray-200' : ''">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer" :class="route().current('statuses.index') ? 'bg-gray-200' : ''">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              ...
              <span class="text-gray-700">
                <jet-nav-link :href="route('decisions.index')" :active="route().current('decisions.index')">
                    Decisions
                  </jet-nav-link>     
              </span>
            </div>
          ...
          <div class="mb-4 px-4">
            <p class="pl-4 text-sm font-semibold mb-1">TEAMS</p>
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
